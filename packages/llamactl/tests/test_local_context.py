...
def test_normalize_to_http_https_strip_creds_and_suffix() -> None:
    assert (
...
def test_normalize_to_http_scp_style() -> None:
    assert (
...
def test_normalize_to_http_strips_explicit_port() -> None:
    assert (
